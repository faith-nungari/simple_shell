 ...
 we coded from scratch a simple Unix shell. A shell is an interactive
...
---
### Authors
* **Dan Omwa** - [@danomwa](https://github.com/danomwa)
* **Faith Nungari - [@faith-nungari](https://github.com/faith-nungari)